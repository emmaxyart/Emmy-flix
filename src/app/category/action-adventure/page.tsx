      ...
      <main className="min-h-screen bg-black text-white pb-16">
        ...
        <section className="px-4 md:px-16 py-8">
                ...
                <div className="relative aspect-[2/3] overflow-hidden rounded-md">
                  {movie.poster_path ? (
                    <Image
                      ...
                      alt={typeof movie.title === "string" ? movie.title : String(movie.title ?? "Movie Poster")}
                      fill
          ...
          <div className="mt-16">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4 md:gap-6">
              {topRatedMovies.map((movie: { id: any; poster_path: any; title: string | number | bigint | boolean | ReactElement<unknown, string | JSXElementConstructor<any>> | Iterable<ReactNode> | Promise<string | number | bigint | boolean | ReactPortal | ReactElement<unknown, string | JSXElementConstructor<any>> | Iterable<ReactNode> | null | undefined> | null | undefined; vote_average: number; }) => (
          ...
          <div className="mt-16">
            ...
            <div className="grid grid-cols-1 gap-6">
              {upcomingMovies.slice(0, 3).map((movie: { id: Key | null | undefined; backdrop_path?: string; title: string; release_date: string; overview: string; }) => (
          ...
          <div className="mt-16">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4 md:gap-6">
              {classicMovies.map((movie: { id: Key | null | undefined; poster_path?: string; title: string; release_date: string; }) => (
